...
export const meta = {
  ...
  date: '2023-07-05',
  title: 'Nuxt 3 Firebase Auth with SSR support',
  description: 'I spend a couple of hours to figure out how to use Firebase Auth with Nuxt 3. Here is what I found.',
  tags: ['Vue', 'Nuxt3', "Firebase"],
}

export default (props) => <ArticleLayout meta={meta} {...props} />

**➡️ Github Project:** [Youhan/nuxt3-firebase-auth-ssr](https://github.com/Youhan/nuxt3-firebase-auth-ssr)

**➡️ Demo:** [https://nuxt3-firebase-auth-ssr.vercel.app/](https://nuxt3-firebase-auth-ssr.vercel.app/)

You can see the result of my explodation in the above repository. I got the ideas from [damien-hl/nuxt3-auth-example](https://github.com/damien-hl/nuxt3-auth-example) and tried to integrate it with Firebase as the Auth provider. 
