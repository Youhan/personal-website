...
```html
    <div class="relative rounded-2xl p-8 border-black/30">
...
First we have a `div` that has a `p-8` for it's content and `border-black/30`, a transparent border so that we could see what is behind it. 
